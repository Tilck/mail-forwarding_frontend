...
!function () {
	...
	function n(n) {
		...
		var l = ["Start", "Add", "Remove", "Update", "End"], u = ["Choose", "Sort", "Filter", "Clone"],
			c = ["Move"].concat(l, u).map(function (t) {
				...
				name: "draggable", props: f, data: function () {
					...
					options: {
						handler: function (t) {
							for (var n in t) c.indexOf(n) == -1 && this._sortable.option(n, t[n])
						}, deep: !0
					}, realList: function () {
						this.computeIndexes()
					}
					...
					getChildrenNodes: function () {
						...
						var n = t.to, e = t.related, o = this.getUnderlyingPotencialDraggableComponent(n);
						if (!o) return {component: o};
						var i = o.realList, r = {list: i, component: o};
						...
						var n = this.visibleIndexes, e = n.length;
						return t > e - 1 ? e : n[t]
						...
						}), o = e.indexOf(n.related), i = t.component.getVmIndex(o), r = e.indexOf(d) != -1;
						return r || !n.willInsertAfter ? i : i + 1
					}, onDragMove: function (t, n) {
						var e = this.move;
						if (!e || !this.realList) return !0;
						var o = this.getRelatedContextFromMoveEvent(t), i = this.context, r = this.computeFutureIndex(o, t);
